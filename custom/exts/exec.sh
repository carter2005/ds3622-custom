...
EXTENSION_IDS="acpid2 boot-wait ing.processor ing.acpi-cpufreq ing.cpufreq_conservative ing.cpufreq_ondemand ing.cpufreq_performance ing.r8125 misc "
...
EXT_8_scripts_on_boot="install_rd.sh"
